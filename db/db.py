...
mycursor.execute("CREATE TABLE face (no int PRIMARY KEY AUTO_INCREMENT NOT NULL, ref_std_id int NOT NULL, FOREIGN KEY (ref_std_id) REFERENCES student(std_id))")
